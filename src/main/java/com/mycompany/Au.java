...
public static void main(String[] args) {
     ...
     * /
      ...
      */
      ...
      numeros[0] = 5; // Atribui um valorpara a posição 1
      ...
      int numeros2[] ={2, 3, 5, 7}; // Declarando com valores de um array
       ...
       * 
       * Seu tamanho assim como array é fixo, em número de linhas e colunas
       * /
       System.out.printIn("------Matriz------");
       ...
       System.out.ptintIn(Arrays.deepToString(matriz2)); // Retorna a representação dos valores
}
